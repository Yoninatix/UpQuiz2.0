...
export default function SubjectsPage() {
  ...
  const subjectLinks = (id: string) => [
    ...
    { to: `/educator/subjects/${id}/generate`,  label: 'Generate',  icon: Sparkles,       color: 'text-violet-600 hover:bg-violet-50' },
    { to: `/educator/subjects/${id}/review`,    label: 'Review',    icon: ClipboardCheck, color: 'text-amber-600  hover:bg-amber-50' },
